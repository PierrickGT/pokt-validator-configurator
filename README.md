...
git clone https://github.com/PierrickGT/pokt-validator-configurator.git
```diff
...
2.1)  ![#1589F0](https://via.placeholder.com/15/FFC000/000000?text=+) git clone https://github.com/PierrickGT/pokt-validator-configurator.git
```diff
